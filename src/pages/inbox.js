    ...
    const viewContentDiv = () => {
      ...
      const viewListContainerDiv = () => {
                ...
                for (let i = 0; i < activeProject.todoList.length; i++) {
                  const todoListItemLi = () => {
                    const get = () => {
                      ...
                      const selectedTodo =
                        projectList[getActiveProject().id].todoList[i];
                    ...
                    const todoListItemCheckboxDiv = () => {
                      const get = () => {
                        const div = document.createElement("div");
                        const liPriority =
                          loadLocalStorage()[getActiveProject().id].todoList[i]
                            .priority;
                    ...
                    const todoListItemContent = () => {
                      ...
                      const get = () => {
                        ...
                        if (todoListItem.dueDate !== "") {
                          div.appendChild(
                            todoListItemDueDateContentDiv().get()
                          );
                        }
                        return div;
                      };
                      ...
                      const todoListItemDueDateContentDiv = () => {
                        ...
                        const todoListItemDueDateP = () => {
                          const get = () => {
                            ...
                            p.textContent =
                              todoListItem.dueDate.readableDueDate;
                    ...
                    const expandTodo = (e = undefined) => {
                      ...
                      const activeProject =
                        loadLocalStorage()[getActiveProject().id];
                      ...
                      const expandedTodoContainer = () => {
                        ...
                        const expandedTodoContent = () => {
                          const getDiv = () => {
                            ...
                            div.appendChild(
                              expandedTodoRightSidebar().getDiv()
                            );
                            return div;
                          };
                          ...
                          const expandedTodoTopContent = () => {
                            const getDiv = () => {
                              ...
                              div.appendChild(
                                projectTitleHeaderContent().getDiv()
                              );
                              div.appendChild(
                                expandedTodoTopRightSidebar().getDiv()
                              );
                              return div;
                            };
                            ...
                            const projectTitleHeaderContent = () => {
                              ...
                              const projectTitleHeader = () => {
                                const getDiv = () => {
                                  ...
                                  div.appendChild(
                                    projectTitleHeaderIcon().getSpan()
                                  );
                                  div.appendChild(
                                    projectTitleHeaderText().getP()
                                  );
                                  return div;
                                };
                                ...
                                const projectTitleHeaderIcon = () => {
                                  const getSpan = () => {
                                    ...
                                    if (activeProject.title === "inbox") {
                                      span.classList.add(
                                        "expanded-todo-top-project-title-header-icon-inbox"
                                      );
                                ...
                                const projectTitleHeaderText = () => {
                                  const getP = () => {
                                    const p = document.createElement("p");
                                    p.id =
                                      "expanded-todo-top-project-title-header-text";
                          ...
                          const expandedTodoBody = () => {
                            const getDiv = () => {
                              ...
                              div.addEventListener(
                                "click",
                                editExpandedTodoBody
                              );
                              div.appendChild(checkboxContainer().getDiv());
                              div.appendChild(
                                expandedTodoTitleContent().getDiv()
                              );
                              div.appendChild(
                                expandedTodoDescription().getDiv()
                              );
                              return div;
                            };
                            ...
                            const editExpandedTodoBody = (e) => {
                              if (
                                e.target.id === "edit-task-cancel-btn" ||
                                e.target.id === "edit-task-save-btn" ||
                              ...
                              const expandedTodoBody = document.querySelector(
                                "#expanded-todo-body"
                              );
                              ...
                              const editTaskActionBtnsContent = () => {
                                ...
                                const closeEditTask = () => {
                                  ...
                                  expandedTodoBody.addEventListener(
                                    "click",
                                    editExpandedTodoBody
                                  );
                                };
                                ...
                                const editTaskSaveBtn = () => {
                                  ...
                                  const saveEditTask = () => {
                                    const editTaskNameInput =
                                      document.querySelector(
                                        "#edit-task-name-input"
                                      );
                                    const editTaskDescriptionInput =
                                      document.querySelector(
                                        "#edit-task-description-input"
                                      );
                                    const titleText = titleContent.firstChild;
                                    const selectedTodoObject =
                                      getSelectedTodo();

                                    selectedTodoObject.selectedTodo.title =
                                      editTaskNameInput.value;
                                    selectedTodoObject.selectedTodo.description =
                                    ...
                                    updateLocalStorage(
                                      selectedTodoObject.projectList
                                    );
                                    closeEditTask();
                                  };
                                  return { get };
                              ...
                              expandedTodoBody.removeEventListener(
                                "click",
                                editExpandedTodoBody
                              );
                              expandedTodoBody.appendChild(
                                taskNameLabel().get()
                              );
                              expandedTodoBody.appendChild(
                                taskDescriptionLabel().get()
                              );
                              expandedTodoBody.appendChild(
                                editTaskActionBtnsContent().get()
                              );
                              titleContent.remove();
                              description.remove();

                              if (
                                e.target.id === "expanded-todo-title-content" ||
                                e.target.id === "expanded-todo-title"
                              ) {
                                document
                                  .querySelector("#edit-task-name-input")
                                  .focus();
                              } else if (
                                e.target.id === "expanded-todo-description"
                              ) {
                                document
                                  .querySelector("#edit-task-description-input")
                                  .focus();
                              }
                            };
                          ...
                          const expandedTodoTopRightSidebar = () => {
                            ...
                            const moreOptionsIcon = () => {
                              ...
                              const openMoreOptions = (e) => {
                                const moreOptionsIcon =
                                  document.querySelector("#more-options-icon");
                                ...
                                const closeMoreOptions = () => {
                                  ...
                                  if (moreOptionsIsolatedContainer === null)
                                    return;
                                  moreOptionsIsolatedContainer.remove();
                                  document
                                    .querySelector("#more-options-container")
                                    .remove();
                                  ...
                                  const moreOptionsContent = () => {
                                    ...
                                    const deleteOptionContent = () => {
                                      const getDiv = () => {
                                        ...
                                        div.addEventListener(
                                          "click",
                                          openDeletionConfirmationMenu
                                        );
                                        div.appendChild(
                                          deleteOptionIcon().getSpan()
                                        );
                                        div.appendChild(
                                          deleteOptionText().getP()
                                        );
                                        return div;
                                      };
                                    ...
                                    const openDeletionConfirmationMenu = () => {
                                      ...
                                      document
                                        ...
                                        .remove();
                                      resetMoreOptionsBehavior();
                                      moreOptionsIcon.classList.remove(
                                        "increase-z-index-by-1"
                                      );
                                      confirmDeletionIsolatedContainer(
                                        selectedTodo
                                      ).appendToParent(
                                        "#expanded-todo-top-right-content"
                                      );
                              ...
                              const render = (ul) => {
                                ...
                                for (let i = 0; i < propertyList.length; i++) {
                                  const getLiInfo = () => {
                                    const getProperty = () => {
                                      if (propertyList[i] === "Project") {
                                        ...
                                        propertyList[i] === "Due date"
                                      ) {
                                        return "Due date";
                                      } else if (
                                        propertyList[i] === "Priority"
                                      ) {
                                        return "Priority";
                                      }
                                    };
                                  ...
                                  const content = () => {
                                    const getDiv = () => {
                                      if (
                                        getLiInfo().getProperty() === "Project"
                                      ) {
                                        const label =
                                          projectDropDownMenuLabel().get();
                                        label.id = `expanded-todo-property-project-content`;
                                        label.classList.add(
                                          "property",
                                          "property-content"
                                        );
                                        label.children[0].classList.add(
                                          "property",
                                          "property-icon"
                                        );
                                        label.children[1].classList.add(
                                          "property"
                                        );
                                        ...
                                        getLiInfo().getProperty() === "Due date"
                                      ) {
                                        ...
                                        dueDateContent.id =
                                          "expanded-todo-property-duedate-info-content";
                                        dueDateContent.classList.add(
                                          "property-content",
                                          "property"
                                        );
                                        ...
                                        dueDateIcon.classList.add(
                                          "property-icon",
                                          "material-symbols-outlined",
                                          "property"
                                        );
                                        dueDateIcon.innerHTML =
                                          "calendar_today";

                                        dueDateText.id =
                                          "expanded-todo-property-duedate-info-text";
                                        dueDateText.classList.add(
                                          "property-text",
                                          "property"
                                        );
                                        dueDateText.textContent =
                                          selectedTodo.dueDate.readableDueDate;
                                        ...
                                        const editDueDate = (e) => {
                                          ...
                                          dueDateInput.valueAsDate = parseJSON(
                                            selectedTodoObject.selectedTodo
                                              .dueDate.dateObject
                                          );
                                          ...
                                          while (
                                            dueDateContent.children.length > 0
                                          ) {
                                          ...
                                          const dueDateSelectIsolatedContainer =
                                            () => {
                                              ...
                                              const save = () => {
                                                ...
                                                const validDueDate =
                                                  getValidDueDate(dateInput);

                                                if (validDueDate === "") return;

                                                selectedTodoObject.selectedTodo.dueDate =
                                                  getValidDueDate(dateInput);
                                          ...
                                          dueDateContent.appendChild(
                                            dueDateSelectIsolatedContainer().get()
                                          );
                                          dueDateContent.appendChild(
                                            dueDateLabel().get()
                                          );
                                        ...
                                        dueDateContent.addEventListener(
                                          "click",
                                          editDueDate,
                                          { once: false }
                                        );
                                        ...
                                        getLiInfo().getProperty() === "Priority"
                                      ) {
                                        const label =
                                          prioritySelectMenu().label;
                                        const icon =
                                          prioritySelectMenu().getPriorityIcon;
                                        ...
                                        if (priority === "P4") {
                                          ...
                                          icon.classList.value = [
                                            "P3 material-symbols-outlined-filled material-symbols-outlined",
                                          ];
                                        } else if (priority === "P2") {
                                          icon.classList.value = [
                                            "P2 material-symbols-outlined-filled material-symbols-outlined",
                                          ];
                                        } else if (priority === "P1") {
                                          icon.classList.value = [
                                            "P1 material-symbols-outlined-filled material-symbols-outlined",
                                          ];
                                        }

                                        label.appendChild(icon);
                                        label.appendChild(
                                          prioritySelectMenu().editPriorityMenu
                                        );
                                        label.addEventListener(
                                          "change",
                                          (e) => {
                                            setPriority(e);
                                            getCheckBoxClassList(
                                              document.querySelector(
        ...
        const openAddTaskMenu = (e) => {
          ...
          const viewListContainerDiv = document.querySelector(
            "#view-list-container"
          );
                ...
                const addTaskActionBtnsContainerDiv = () => {
                  ...
                  const addTaskActionBtnsContentDiv = () => {
                    ...
                    const removeAddTaskMenu = () => {
                      document
                        .querySelector("#add-task-menu-container")
                        .remove();
                      viewListContainerDiv.appendChild(addTaskContentDiv);
                    };
  ...
  const getPriority = () => {
    if (e !== null) {
      ...
      const priorityIcon = document.querySelector(
        "#expanded-todo-property-priority-info-icon"
      );
...
const removeContainer = (e) => {
  if (
    e.currentTarget.id === "confirm-deletion-cancel-btn" ||
    e.target.id === "confirm-deletion-isolated-container" ||
    e.currentTarget.id === "confirm-deletion-close-icon"
  ) {
...
const toggleExpandedTodoProperties = () => {
  const expandedTodoPropertyList = document.querySelector(
    "#expanded-todo-property-list"
  );
...
const editPriority = (e, todoListId, projectListId) => {
  ...
  const priorityInfoContent = document.querySelector(
    "#expanded-todo-property-priority-info-content"
  );
  const projectList = loadLocalStorage();
