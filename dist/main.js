                                  ...
                                  const content = () => {
                                    const getDiv = () => {
                                      if (getLiInfo().getProperty() === 'Project') {
                                        ...
                                        const priority = (0,_todo__WEBPACK_IMPORTED_MODULE_2__.getSelectedTodo)().selectedTodo.priority;
...
const prioritySelectMenu = () => {
  ...
  const renderOptions = (select) => {
    if ((0,_todo__WEBPACK_IMPORTED_MODULE_2__.getSelectedTodo)() === undefined) return;
    const selectedTodo = (0,_todo__WEBPACK_IMPORTED_MODULE_2__.getSelectedTodo)().selectedTodo;
