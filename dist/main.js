                        ...
                        const expandedTodoContent = () => {
                          const getListId = () => {
                            if (checkIfEventInput && e.currentTarget !== null) {
                              return {projectListId:(0,_todo__WEBPACK_IMPORTED_MODULE_2__.getActiveProject)().id, todoListId:e.currentTarget.dataset.listId};
                            }
                            else if (checkIfEventInput) {
                              return {projectListId:(0,_todo__WEBPACK_IMPORTED_MODULE_2__.getActiveProject)().id, todoListId:document.querySelector('#expanded-todo-content').todoListId};
                            }
                              ...
                              const editTaskActionBtnsContent = () => {
                                ...
                                const editTaskSaveBtn = () => {
                                  ...
                                  const saveEditTask = () => {
                                    ...
                                    projectList[(0,_todo__WEBPACK_IMPORTED_MODULE_2__.getActiveProject)().id].todoList[getListId().todoListId].title = editTaskNameInput.value;
                                    projectList[(0,_todo__WEBPACK_IMPORTED_MODULE_2__.getActiveProject)().id].todoList[getListId().todoListId].description = editTaskDescriptionInput.value;
                                    ...
                                    const getDiv = () => {
                                      if (getLiInfo().getProperty() === 'Project') {
                                        ...
                                        label.addEventListener('change', (e) => {
                                          const getListId = (0,_todo__WEBPACK_IMPORTED_MODULE_2__.updateProject)(e);
                                          const todoListId = getListId.todoListId;
                                          const projectListId = getListId.projectListId;

                                          (0,_todo__WEBPACK_IMPORTED_MODULE_2__.selectProject)(projectListId, false);
                                        ...
                                        const editDueDate = (e) => {
                                          ...
                                          dueDateInput.valueAsDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(projectList[projectListId].todoList[todoListId].dueDate.dateObject);
                                          ...
                                          const dueDateSelectIsolatedContainer = () => {
                                            ...
                                            const save = () => {
                                              ...
                                              projectList[projectListId].todoList[todoListId].dueDate = (0,_todo__WEBPACK_IMPORTED_MODULE_2__.getValidDueDate)(dateInput);
                                              (0,_todo__WEBPACK_IMPORTED_MODULE_2__.updateLocalStorage)(projectList);
                                            }
